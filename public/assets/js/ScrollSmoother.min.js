...
!function (e, t) {
    ...
    var D, L, O, N, U, J, K, q, V, j, Y, W, G, Q, X, r = (ScrollSmoother.register = function register(e) {
        return L || (D = e || t(), s() && window.document && (O = window, N = document, U = N.documentElement, J = N.body), D && (K = D.utils.toArray, q = D.utils.clamp, Y = D.parseEase("expo"), Q = D.core.context || function () {
    ...
    function ScrollSmoother(t) {
        ...
        function Ja() {
            Aa(), requestAnimationFrame(Aa), b && (b.forEach(function (e) {
                var t = e.start, r = e.auto ? Math.min(V.maxScroll(e.scroller), e.end) : t + (e.end - t) / e.ratio,
                    n = (r - e.end) / 2;
        ...
        function Oa(r, e, t, n, o) {
            ...
            function Jb(e) {
                if (a) {
                    ...
                    var t = function _autoDistance(e, t) {
                        var r, n, o = e.parentNode || U, i = e.getBoundingClientRect(), s = o.getBoundingClientRect(),
            ...
            var i, s, a, l, c, u, f = Na("speed", e, n, r), h = Na("lag", t, n, r), d = D.getProperty(r, "y"),
                g = r._gsap, p = [], m = [], v = 0;
        ...
        var n, S, e, i, b, s, a, l, c, u, r, f, h, d, g, p = t.smoothTouch, m = t.onUpdate, v = t.onStop, w = t.smooth,
            T = t.onFocusIn, E = t.normalizeScroll, x = t.wholePixels, C = this, P = t.effectsPrefix || "",
            R = V.getScrollFunc(O),
            k = 1 === V.isTouch ? !0 === p ? .8 : parseFloat(p) || 0 : 0 === w || !1 === w ? 0 : parseFloat(w) || .8,
            _ = k && +t.speed || 1, H = 0, A = 0, F = 1, M = W(0), I = {y: 0},
        ...
        Ka(), V.addEventListener("killAll", Ka), D.delayedCall(.5, function () {
            ...
            var r, n = (e = K(e)[0]).style.cssText, o = V.create({trigger: e, start: t || "top top"});
            ...
            if (arguments.length) {
                ...
                return t !== n && (c = (n = t).getAttribute("style") || "", z && z.observe(n), D.set(n, {
                    ...
                    y: "+=0"
                }), k || D.set(n, {clearProps: "transform"})), this
            }
            return n
        ...
        B.forEach(function (e) {
        ...
        }, i.getTween() && (i.getTween().vars.ease = t.ease || Y), this.scrollTrigger = i, t.effects && this.effects(!0 === t.effects ? "[data-" + P + "speed], [data-" + P + "lag]" : t.effects, {effectsPadding: t.effectsPadding}), t.sections && this.sections(!0 === t.sections ? "[data-section]" : t.sections), B.forEach(function (e) {
            ...
            var r = V.defaults({});
            r && r.scroller === S && V.defaults({scroller: O}), o.normalizer && V.normalizeScroll(!1), clearInterval(a), j = null, z && z.disconnect(), J.style.removeProperty("height"), O.removeEventListener("focusin", Ha)
        }, this.refresh = function (e, t) {
            return i.refresh(e, t)
        }, E && (this.normalizer = V.normalizeScroll(!0 === E ? {
            debounce: !0,
            content: !k && n
        } : E)), V.config(t), "overscrollBehavior" in O.getComputedStyle(J) && D.set([J, U], {overscrollBehavior: "none"}), "scrollBehavior" in O.getComputedStyle(J) && D.set([J, U], {scrollBehavior: "auto"}), O.addEventListener("focusin", Ha), a = setInterval(ya, 250), "loading" === N.readyState || requestAnimationFrame(function () {
            return V.refresh()
        })
    }
