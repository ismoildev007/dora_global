                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item mb-50">
                            <div class="img">
                                ...
                                <div class="date">
                                    <a href="{{ route('blog.show', $blog->id) }}">{{ $blog->created_at->format('d M Y') }}</a>
                                </div>
                            </div>
                            <div class="cont mt-30">
                                ...
                                <a href="{{ route('blog.show', $blog->id) }}" class="mt-20 ls1 sub-title">Read More
                                    <i class="ml-5">
