                        ...
                        <div class="row mt-50">
                            <div class="col-lg-11 offset-lg-1">
                                ...
                                <div class="list-arrow mt-50">
                                    <ul class="rest">
                                        <li class="mb-20"><span class="icon main-color3"><i class="fas fa-check-double"></i></span> Prioritize the features
                                            your customers need
                                        <li>
                                        <li class="mb-20"><span class="icon main-color3"><i class="fas fa-check-double"></i></span> Align everyone around
                                            the roadmap</li>
                                        <li><span class="icon main-color3"><i class="fas fa-check-double"></i></span> Define your product
