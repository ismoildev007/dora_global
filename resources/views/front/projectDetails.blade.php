...
<head>
    ...
    <meta name="keywords" content="Разработка сайтов, СММ продвижение, Создание сайтов, Продвижение соц сетях, Разработка интернет магазинов в ташкенте, разработка логотипов в ташкенте, разработка телеграм ботов, создание телеграм ботов, брендинг в ташкенте, сео продвижение, seo продвижение сайтов в ташкенте, контекстная реклама, срм системы в ташкенте, программа для автоматизации, битрикс24, разработчики сайтов, рекламные ролики, видеосъемка в ташкенте, рекламные компании, веб студия, онлайн реклама, нейминг в ташкенте, разработка мобильных приложении, amocrm, амосрм, мой склад, складской учет, программа для торговли">
    <meta name="description" content="Creation of sites in Tashkent. SEO promotion. Digital marketing with guaranteed results! Internet marketing from a certified Google partner. DORA">
    <meta name="author" content="DORA® | International Marketing Company">

    <!-- Title  -->
    <title>DORA® | International Marketing Company</title>

    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="76x76" href="assets/imgs/fav/apple-touch-icon.png">
    ...
    <link href="../../../css2-2?family=Epilogue:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
...
<div id="navi" class="topnav">
    <div class="container">
        <div class="logo icon-img-120">
            <a href="index.html"><img src="assets/imgs/logo-light.png" alt=""></a>
        </div>
            ...
            <div class="col-lg-7">
                <div class="menu-links">
                    ...
                    <ul class="main-menu rest">
                        ...
                        <li>
                            <div class="o-hidden">
                                <a href="/" class="link"><span class="fill-text" data-text="Home">Home</span></a>
                            </div>
                        </li>
                        <li>
                            <div class="o-hidden">
                                <div class="link cursor-pointer dmenu"><span class="fill-text" data-text="DORA®">DORA®</span> <i></i>
                                </div>
                            </div>
                            <div class="sub-menu">
                                <ul>
                                    <li>
                                        <a href="{{route('about')}}" class="sub-link">About</a>
                                    </li>
                                    <li>
                                        <a href="{{route('about')}}" class="sub-link">Mission</a>
                                    </li>
                                    <li>
                                        <a href="{{route('partnerships')}}" class="sub-link">Partners</a>
                                    </li>
                                    <li>
                                        <a href="{{route('portfolio')}}" class="sub-link">Our Team</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="o-hidden">
                                <a href="{{route('services')}}" class="link"><span class="fill-text" data-text="Services">Services</span></a>
                            </div>
                        </li>

                        <li>
                            <div class="o-hidden">
                                <a href="{{route('portfolio')}}" class="link"><span class="fill-text" data-text="Portfolio">Portfolio</span></a>
                            </div>
                        </li>
                        <li>
                            <div class="o-hidden">
                                <a href="{{route('blog')}}" class="link"><span class="fill-text" data-text="Blog">Blog</span></a>
                            </div>
                        </li>
                        <li>
                            <div class="o-hidden">
                                <a href="{{route('contact')}}" class="link"><span class="fill-text" data-text="Contact">Contact</span></a>
                            </div>
                        </li>
            ...
            <div class="col-lg-3 d-flex align-items-end">
                <div class="cont-info full-width">
                    <div class="item">
                        ...
                        <p>st. Chilanzar 2/2, Tashkent, Uzbekistan</p>
                        <p class="underline main-color mt-5 mb-5"><a href="#0">+998 93 512 5324</a></p>
                        <p><a href="#0">info@doraglobal.org</a></p>
                    </div>
...
<main class="main-bg">
    ...
    <header class="proj-header2 bg-img valign parallaxie" data-background="https://uithemez.com/i/geekfolio/dark/assets/imgs/works/projects/2/1.jpg" data-overlay-dark="5">
    ...
    <section class="section-padding">
        ...
        <div class="back-image bg-img parallaxie mt-100" data-background="https://uithemez.com/i/geekfolio/dark/assets/imgs/works/projects/2/2.jpg"></div>
    </section>
...
<section class="call-action-img">
    <div class="container">
        <div class="sec-bg-img bg-img parallaxie" data-background="https://uithemez.com/i/geekfolio/dark/assets/imgs/works/projects/1/1.jpg"></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 md-mb50">
                    ...
                    <ul class="rest social-text">
                        <li>
                            <a href="https://www.facebook.com/doradev.uz">Facebook</a>
                        </li>
                        <li>
                            <a href="https://instagram.com/dora.uz">Instagram</a>
                        </li>
                        <li>
                            <a href="https://t.me/dora_support">Telegram</a>
                        </li>
                        <li>
                            <a href="https://www.linkedin.com/company/dora-holding/">LinkedIn</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="copyright d-flex">
                            <div class="ml-auto">
                                <p class="fz-13">DORA® | International Marketing Company</p>
                            </div>
                        </div>
                    </div>
                </div>
