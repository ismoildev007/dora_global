            ...
            <div class="row grid md-marg">
                ...
                <div class="col-lg-4 col-md-6 items web info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/1.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
                            ...
                            <h6 class="sub-title tag"><a href="project-details2.html">© 2023 <br> Design ART</a></h6>
                            <h5><a href="project-details2.html">Character Design</a></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 items app info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/2.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
                ...
                <div class="col-lg-4 col-md-6 items brand info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/3.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
                ...
                <div class="col-lg-4 col-md-6 items web info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/4.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
                ...
                <div class="col-lg-4 col-md-6 items brand info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/6.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
                ...
                <div class="col-lg-4 col-md-6 items app info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/5.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
                ...
                <div class="col-lg-4 col-md-6 items web info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/7.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
                ...
                <div class="col-lg-4 col-md-6 items brand info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/8.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
                ...
                <div class="col-lg-4 col-md-6 items app info-overlay mb-50">
                    <div class="item-img o-hidden">
                        <a href="project-details2.html" class="imago wow">
                            <div class="inner wow">
                                <img src="/front/assets/imgs/works/grid2/9.jpg" alt="image">
                            </div>
                        </a>
                        <div class="info">
                            <span class="mb-15">
