            ...
            <div class="row">
                ...
                <div class="filtering col-12 mb-80 text-center">
                    <div class="filter">
                        ...
                        <span data-filter='.1' data-count="03">Branding</span>
                        <span data-filter='.2' data-count="02">Mobile App</span>
                        <span data-filter='.3' data-count="03">Creative</span>
                    </div>
                </div>
            </div>
            ...
            <div class="gallery">
                ...
                <div class="row grid md-marg">
                    @foreach($portfolios as $port)
                        <div class="col-lg-4 col-md-6 items {{ $port->brend_id }} info-overlay mb-50">
                            <div class="item-img o-hidden">
                                <a href="/projectDetail" class="imago wow">
                                    <div class="inner wow">
                                        <img src="{{ asset('storage/' . $port->image) }}" alt="image">
                                    </div>
                                </a>
                                <div class="info">
                                    <span class="mb-15">
                                    ...
                                    <h6 class="sub-title tag"><a href="/projectDetail">{{ $port->title }}</a></h6>
                                    <h5><a href="/projectDetail">{{ $port->brend->title }}</a></h5>
                                </div>
                            </div>
                        </div>
                    @endforeach
