...
<header class="crev-header">
    ...
    <div class="main-img">
        <img src="/front/assets/imgs/background/14.jpg" alt="">
    </div>
    <div class="bg-pattern bg-img" data-background="/front/assets/imgs/patterns/graph.png"></div>
</header>
            ...
            <div class="col-lg-6 rest">
                <div class="imgs md-mb50">
                    <div class="img1">
                        <div class="o-hidden">
                            <div class="imago wow">
                                <img src="/front/assets/imgs/about/01.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="img2">
                        <div class="o-hidden">
                            <div class="imago wow">
                                <img src="/front/assets/imgs/about/1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img icon-img-100">
                                        <a href="#0">
                                            <img src="/front/assets/imgs/brands/01.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img icon-img-100">
                                        <a href="#0">
                                            <img src="/front/assets/imgs/brands/02.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img icon-img-100">
                                        <a href="#0">
                                            <img src="/front/assets/imgs/brands/03.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img icon-img-100">
                                        <a href="#0">
                                            <img src="/front/assets/imgs/brands/04.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img icon-img-100">
                                        <a href="#0">
                                            <img src="/front/assets/imgs/brands/05.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="serv-item lg-pad md-mb50 radius-5 wow fadeIn" data-wow-delay=".5s">
                    <div class="icon-img-50 mb-40">
                        <img src="/front/assets/imgs/serv-iconS/12.svg" alt="">
                    </div>
                    <!-- <span class="mb-10 opacity-7">Product Design</span> -->
                    <h6 class="mb-15">Development</h6>
                    <p class="fz-14">We are website developers who specialize in creating functional websites for businesses.</p>
                    <div class="crv-more">
                        <a href="page-services.html" class="mt-30 ls1 fz-12 text-u">Read More<svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.922 4.5V11.8125C13.922 11.9244 13.8776 12.0317 13.7985 12.1108C13.7193 12.1899 13.612 12.2344 13.5002 12.2344C13.3883 12.2344 13.281 12.1899 13.2018 12.1108C13.1227 12.0317 13.0783 11.9244 13.0783 11.8125V5.51953L4.79547 13.7953C4.71715 13.8736 4.61092 13.9176 4.50015 13.9176C4.38939 13.9176 4.28316 13.8736 4.20484 13.7953C4.12652 13.717 4.08252 13.6108 4.08252 13.5C4.08252 13.3892 4.12652 13.283 4.20484 13.2047L12.4806 4.92188H6.18765C6.07577 4.92188 5.96846 4.87743 5.88934 4.79831C5.81023 4.71919 5.76578 4.61189 5.76578 4.5C5.76578 4.38811 5.81023 4.28081 5.88934 4.20169C5.96846 4.12257 6.07577 4.07813 6.18765 4.07812H13.5002C13.612 4.07813 13.7193 4.12257 13.7985 4.20169C13.8776 4.28081 13.922 4.38811 13.922 4.5Z" fill="currentColor"></path>
                            </svg></a>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="serv-item lg-pad md-mb50 radius-5 wow fadeIn" data-wow-delay=".8s">
                    <div class="icon-img-50 mb-40">
                        <img src="/front/assets/imgs/serv-icons/09.svg" alt="">
                    </div>
                    <!-- <span class="mb-10 opacity-7">Customs Services</span> -->
                    <h6 class="mb-15">Marketing</h6>
                    <p class="fz-14">We help businesses maximize their potential by developing effective marketing strategies.</p>
                    <div class="crv-more">
                        <a href="page-services.html" class="mt-30 ls1 fz-12 text-u">Read More<svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.922 4.5V11.8125C13.922 11.9244 13.8776 12.0317 13.7985 12.1108C13.7193 12.1899 13.612 12.2344 13.5002 12.2344C13.3883 12.2344 13.281 12.1899 13.2018 12.1108C13.1227 12.0317 13.0783 11.9244 13.0783 11.8125V5.51953L4.79547 13.7953C4.71715 13.8736 4.61092 13.9176 4.50015 13.9176C4.38939 13.9176 4.28316 13.8736 4.20484 13.7953C4.12652 13.717 4.08252 13.6108 4.08252 13.5C4.08252 13.3892 4.12652 13.283 4.20484 13.2047L12.4806 4.92188H6.18765C6.07577 4.92188 5.96846 4.87743 5.88934 4.79831C5.81023 4.71919 5.76578 4.61189 5.76578 4.5C5.76578 4.38811 5.81023 4.28081 5.88934 4.20169C5.96846 4.12257 6.07577 4.07813 6.18765 4.07812H13.5002C13.612 4.07813 13.7193 4.12257 13.7985 4.20169C13.8776 4.28081 13.922 4.38811 13.922 4.5Z" fill="currentColor"></path>
                            </svg></a>
            ...
            <div class="col-lg-4">
                <div class="serv-item lg-pad radius-5 wow fadeIn" data-wow-delay="1.2s">
                    <div class="icon-img-50 mb-40">
                        <img src="/front/assets/imgs/serv-icons/11.svg" alt="">
                    </div>
                    <!-- <span class="mb-10 opacity-7">Product Development</span> -->
                    <h6 class="mb-15">Branding</h6>
                    <p class="fz-14">We help businesses establish a strong identity that resonates with their target audience.</p>
                    <div class="crv-more">
                        <a href="page-services.html" class="mt-30 ls1 fz-12 text-u">Read More<svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.922 4.5V11.8125C13.922 11.9244 13.8776 12.0317 13.7985 12.1108C13.7193 12.1899 13.612 12.2344 13.5002 12.2344C13.3883 12.2344 13.281 12.1899 13.2018 12.1108C13.1227 12.0317 13.0783 11.9244 13.0783 11.8125V5.51953L4.79547 13.7953C4.71715 13.8736 4.61092 13.9176 4.50015 13.9176C4.38939 13.9176 4.28316 13.8736 4.20484 13.7953C4.12652 13.717 4.08252 13.6108 4.08252 13.5C4.08252 13.3892 4.12652 13.283 4.20484 13.2047L12.4806 4.92188H6.18765C6.07577 4.92188 5.96846 4.87743 5.88934 4.79831C5.81023 4.71919 5.76578 4.61189 5.76578 4.5C5.76578 4.38811 5.81023 4.28081 5.88934 4.20169C5.96846 4.12257 6.07577 4.07813 6.18765 4.07812H13.5002C13.612 4.07813 13.7193 4.12257 13.7985 4.20169C13.8776 4.28081 13.922 4.38811 13.922 4.5Z" fill="currentColor"></path>
                            </svg></a>
...
<section class="works thecontainer">
    ...
    <div class="panel mt-30">
        <div class="item">
            <div class="img">
                <img src="/front/assets/imgs/portfolio/4/01.jpg" alt="">
            </div>
    ...
    <div class="panel mt-30">
        <div class="item">
            <div class="img">
                <img src="/front/assets/imgs/portfolio/4/02.jpg" alt="">
            </div>
            <div class="cont d-flex align-items-end">
                <div>
                    <span>Web Design</span>
    ...
    <div class="panel mt-30">
        <div class="item">
            <div class="img">
                <img src="/front/assets/imgs/portfolio/4/03.jpg" alt="">
            </div>
            <div class="cont d-flex align-items-end">
                <div>
                    <span>Web Design</span>
    ...
    <div class="panel mt-30">
        <div class="item">
            <div class="img">
                <img src="/front/assets/imgs/portfolio/4/04.jpg" alt="">
            </div>
            <div class="cont d-flex align-items-end">
                <div>
                    <span>Web Design</span>
    ...
    <div class="panel mt-30">
        <div class="item">
            <div class="img">
                <img src="/front/assets/imgs/portfolio/4/05.jpg" alt="">
            </div>
            <div class="cont d-flex align-items-end">
                <div>
                    <span>Web Design</span>
    ...
    <div class="panel mt-30">
        <div class="item">
            <div class="img">
                <img src="/front/assets/imgs/portfolio/4/06.jpg" alt="">
            </div>
            <div class="cont d-flex align-items-end">
                <div>
                    <span>Web Design</span>
            ...
            <div class="col-lg-5 valign">
                <div class="serv-tab-link tab-links full-width md-mb50">
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <ul class="rest">
                                <li class="item-link current mb-15 pb-15 bord-thin-bottom" data-tab="tabs-1"><span>01</span> UI/UX
                                    Design</li>
            ...
            <div class="col-lg-6">
                <div class="serv-tab-cont">
                    <div class="tab-content current" id="tabs-1">
                        <div class="item">
                            <div class="img">
                                <img src="/front/assets/imgs/sass-img/serv/4.jpg" alt="">
                            </div>
                    ...
                    <div class="tab-content" id="tabs-2">
                        <div class="item">
                            <div class="img">
                                <img src="/front/assets/imgs/sass-img/serv/2.jpg" alt="">
                            </div>
                            <div class="cont sub-bg">
                                <div class="icon-img-60 mb-40">
                                    <img src="/front/assets/imgs/serv-icons/1.png" alt="">
                    ...
                    <div class="tab-content" id="tabs-3">
                        <div class="item">
                            <div class="img">
                                <img src="/front/assets/imgs/sass-img/serv/3.jpg" alt="">
                            </div>
                            <div class="cont sub-bg">
                                <div class="icon-img-60 mb-40">
            ...
            <div class="col-lg-5 position-re wow fadeIn" data-wow-delay=".4s">
                <div class="bord-qoute d-flex align-items-center justify-content-center">
                    <div class="qoute-icon main-bg">
                        <img src="/front/assets/imgs/svg-assets/quote.png" alt="">
                    </div>
                </div>
                <div class="img-qoute">
                    <img src="/front/assets/imgs/about/sq1.jpg" alt="">
                </div>
            </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <div class="img circle-60">
                                                <img src="/front/assets/imgs/testim/1.jpg" alt="" class="circle-img">
                                            </div>
                                        </div>
                                        <div class="ml-30">
                                            <div class="info">
                            ...
                            <div class="swiper-slide">
                                <div class="item">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <div class="img circle-60">
                                                <img src="/front/assets/imgs/testim/2.jpg" alt="" class="circle-img">
                                            </div>
                                        </div>
                                        <div class="ml-30">
                                            <div class="info">
            ...
            <div class="col-lg-6">
                <div class="item md-mb80">
                    <div class="row rest">
                        <div class="col-md-6">
                            <div class="img">
                                <img src="/front/assets/imgs/blog/h1.jpg" alt="">
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="item">
                    <div class="row rest">
                        <div class="col-md-6">
                            <div class="img">
                                <img src="/front/assets/imgs/blog/h4.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-md-6 valign">
                            <div class="cont">
