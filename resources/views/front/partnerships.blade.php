            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="/partnerships">Partners</a>
                        <a class="dropdown-item" href="javascript: void(0);">Our Team</a>
                    </div>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="/services"><span class="rolling-text">Services</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/portfolio"><span class="rolling-text">Portfolio</span></a>
                </li>
                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="caption">
                        ...
                        <h1 class="fz-80">Our Partners</h1>
                    </div>
                </div>
            </div>
        </div>
...
<!-- ==================== Start Footer ==================== --><footer class="sub-bg">
