            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="serv-item md-mb50 radius-10">
                        ...
                        <h5 class="mb-30 pb-30 bord-thin-bottom">Development</h5>
                ...
                <div class="col-lg-4">
                    <div class="serv-item md-mb50 radius-10">
                        ...
                        <h5 class="mb-30 pb-30 bord-thin-bottom">Marketing</h5>
                        <p>Creating a higher spacing and how people move through a unique.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="serv-item radius-10">
                        ...
                        <h5 class="mb-30 pb-30 bord-thin-bottom">Branding</h5>
                        <p>Creating a higher spacing and how people move through a unique.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid rest">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="swiper4" data-carousel="swiper" data-items="4" data-loop="true" data-space="60" data-center="true" data-speed="1000">
                        <div id="content-carousel-container-unq-team" class="swiper-container" data-swiper="container">
