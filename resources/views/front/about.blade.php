...
<section class="pg-about section-padding sub-bg">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="bg-img radius-10 md-mb50" data-background="/front/assets/imgs/about/sq1.jpg"></div>
            </div>
            <div class="col-lg-8">
                <div class="bg-img radius-10" data-background="/front/assets/imgs/about/sq2.jpg"></div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row justify-content-around">
            <div class="col-lg-5 valign md-mb50">
                <div class="imgs mb-80">
                    <div class="img1">
                        <img src="/front/assets/imgs/about/sq1.jpg" alt="" class="radius-10">
                    </div>
                    <div class="img2">
                        <img src="/front/assets/imgs/about/sq2.jpg" alt="" class="radius-10">
                    </div>
                </div>
            </div>
                    ...
                    <div id="content-carousel-container-unq-team" class="swiper-container" data-swiper="container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img">
                                        <img src="/front/assets/imgs/team/1.jpg" alt="">
                                    </div>
                                    <div class="info">
                            ...
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img">
                                        <img src="/front/assets/imgs/team/2.jpg" alt="">
                                    </div>
                                    <div class="info">
                                        <div class="main-marq team-position">
                                            <div class="slide-har st1 non-strok">
                            ...
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img">
                                        <img src="/front/assets/imgs/team/3.jpg" alt="">
                                    </div>
                                    <div class="info">
                                        <div class="main-marq team-position">
                                            <div class="slide-har st1 non-strok">
                            ...
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="img">
                                        <img src="/front/assets/imgs/team/4.jpg" alt="">
                                    </div>
                                    <div class="info">
                                        <div class="main-marq team-position">
                                            <div class="slide-har st1 non-strok">
